...
<details>
  ...
  ```shell
  curl -sL -o ./aws-knox_3.1.0_amd64.deb https://github.com/null93/aws-knox/releases/download/3.1.0/aws-knox_3.1.0_amd64.deb
  sudo dpkg -i ./aws-knox_3.1.0_amd64.deb
  rm ./aws-knox_3.1.0_amd64.deb
  ```

  ### arm64

  ```shell
  curl -sL -o ./aws-knox_3.1.0_arm64.deb https://github.com/null93/aws-knox/releases/download/3.1.0/aws-knox_3.1.0_arm64.deb
  sudo dpkg -i ./aws-knox_3.1.0_arm64.deb
  rm ./aws-knox_3.1.0_arm64.deb
  ```
</details>
...
<details>
  ...
  ```shell
  rpm -i https://github.com/null93/aws-knox/releases/download/3.1.0/aws-knox-3.1.0-1.aarch64.rpm
  ```

  ### x86_64

  ```shell
  rpm -i https://github.com/null93/aws-knox/releases/download/3.1.0/aws-knox-3.1.0-1.x86_64.rpm
  ```
</details>
...
<details>
  ...
  ```shell
  curl -sL -o ./aws-knox_3.1.0_aarch64.apk https://github.com/null93/aws-knox/releases/download/3.1.0/aws-knox_3.1.0_aarch64.apk
  apk add --allow-untrusted ./aws-knox_3.1.0_aarch64.apk
  rm ./aws-knox_3.1.0_aarch64.apk
  ```

  ### x86_64

  ```shell
  curl -sL -o ./aws-knox_3.1.0_x86_64.apk https://github.com/null93/aws-knox/releases/download/3.1.0/aws-knox_3.1.0_x86_64.apk
  apk add --allow-untrusted ./aws-knox_3.1.0_x86_64.apk
  rm ./aws-knox_3.1.0_x86_64.apk
  ```
</details>
...
<details>
  ...
  ```shell
  curl -sL -o ./aws-knox-3.1.0-1-aarch64.pkg.tar.zst https://github.com/null93/aws-knox/releases/download/3.1.0/aws-knox-3.1.0-1-aarch64.pkg.tar.zst
  sudo pacman -U ./aws-knox-3.1.0-1-aarch64.pkg.tar.zst
  rm ./aws-knox-3.1.0-1-aarch64.pkg.tar.zst
  ```

  ### x86_64

  ```shell
  curl -sL -o ./aws-knox-3.1.0-1-x86_64.pkg.tar.zst https://github.com/null93/aws-knox/releases/download/3.1.0/aws-knox-3.1.0-1-x86_64.pkg.tar.zst
  sudo pacman -U ./aws-knox-3.1.0-1-x86_64.pkg.tar.zst
  rm ./aws-knox-3.1.0-1-x86_64.pkg.tar.zst
  ```
</details>
